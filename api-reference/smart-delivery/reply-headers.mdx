...
api: "GET https://smartdelivery.smartlead.ai/api/v1/smart-delivery/reply-headers"
description: "Analyze email headers from test replies for advanced diagnostics"
---
...
```bash cURL
curl "https://smartdelivery.smartlead.ai/api/v1/smart-delivery/reply-headers?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://smartdelivery.smartlead.ai/api/v1/smart-delivery/reply-headers",
...
const response = await fetch(
  `https://smartdelivery.smartlead.ai/api/v1/smart-delivery/reply-headers?api_key=${API_KEY}`
);
