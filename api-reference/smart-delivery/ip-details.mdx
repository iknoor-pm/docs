---
title: "IP Details"
api: "GET https://smartdelivery.smartlead.ai/api/v1/smart-delivery/ip-details"
description: "Get comprehensive information about sending IP addresses"
---
...
```bash cURL
curl "https://smartdelivery.smartlead.ai/api/v1/smart-delivery/ip-details?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://smartdelivery.smartlead.ai/api/v1/smart-delivery/ip-details",
...
const response = await fetch(
  `https://smartdelivery.smartlead.ai/api/v1/smart-delivery/ip-details?api_key=${API_KEY}`
);
