...
api: "GET https://server.smartlead.ai/api/v1/analytics/campaign/list"
description: "Retrieve list of all campaigns for building selectors and filtering"
---
...
```bash cURL
curl "https://server.smartlead.ai/api/v1/analytics/campaign/list?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://server.smartlead.ai/api/v1/analytics/campaign/list",
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/analytics/campaign/list?api_key=${API_KEY}`
);
