...
api: "GET https://server.smartlead.ai/api/v1/analytics/client/list"
description: "Get list of all clients for agency account filtering and selection"
---
...
response = requests.get(
    "https://server.smartlead.ai/api/v1/analytics/client/list",
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/analytics/client/list?api_key=${API_KEY}`
);
