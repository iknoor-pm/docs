...
api: "GET https://server.smartlead.ai/api/v1/analytics/client/overall-stats"
description: "Get performance metrics by client for agency reporting and analysis"
---
...
| `positive_replied` | `COUNT(DISTINCT lead)` tagged **positive** (`sentiment_type = 'positive'`), attributed to send date, no reply-event requirement. |
