...
api: "GET https://server.smartlead.ai/api/v1/analytics/client/month-wise-count"
description: "Get monthly breakdown of active clients showing growth trends"
---
...
response = requests.get(
    "https://server.smartlead.ai/api/v1/analytics/client/month-wise-count",
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/analytics/client/month-wise-count?api_key=${API_KEY}`
);
