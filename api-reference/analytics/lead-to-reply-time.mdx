...
api: "GET https://server.smartlead.ai/api/v1/analytics/campaign/lead-to-reply-time"
description: "Measure average time from first email sent to first reply received"
---
...
```bash cURL
curl "https://server.smartlead.ai/api/v1/analytics/campaign/lead-to-reply-time?api_key=YOUR_KEY"
```
...
response = requests.get(
    "https://server.smartlead.ai/api/v1/analytics/campaign/lead-to-reply-time",
...
const response = await fetch(
  `https://server.smartlead.ai/api/v1/analytics/campaign/lead-to-reply-time?api_key=${API_KEY}`
);
