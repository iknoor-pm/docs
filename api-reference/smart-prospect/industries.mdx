---
title: "Industries API"
api: "GET https://prospect-api.smartlead.ai/api/v1/search-email-leads/industries"
description: "List industries for the authenticated user - GET /industries"
---
...
<ParamField query="withSubIndustry" type="string">
